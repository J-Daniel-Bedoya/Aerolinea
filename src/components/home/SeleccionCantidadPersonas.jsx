...
const SeleccionCantidadPersonas = ({
  totalPersonas,
  adultos,
  niños,
  bebes,
      ...
      <div className="catidadPersonas__card">
        <div className="catidadPersonas__card--content">
          ...
          <div className="content__acount">
            <button
              onClick={() => setContadorAdultos(contadorAdultos - 1)}
              disabled={contadorAdultos <= 0}
            >
              -
            </button>
            <p>{contadorAdultos}</p>
        ...
        <div className="catidadPersonas__card--content">
          ...
          <div className="content__acount">
            <button
              onClick={() => setContadorNiños(contadorNiños - 1)}
              disabled={contadorNiños <= 0}
            >
              -
            </button>
            <p>{contadorNiños}</p>
        ...
        <div className="catidadPersonas__card--content">
          ...
          <div className="content__acount">
            <button
              onClick={() => setContadorBebes(contadorBebes - 1)}
              disabled={contadorBebes <= 0}
            >
              -
            </button>
            <p>{contadorBebes}</p>
        ...
        <button
          onClick={() =>
            totalPersonas(contadorAdultos, contadorNiños, contadorBebes)
          }
